...
public class StarDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        */
        ...
        //Center the string in the triangle.
        //String s = "Equilateral";
        //Rect bounds = new Rect();
        //textPaint.getTextBounds(s, 0, s.length(), bounds); //How big is s? Put 4 numbers into bounds.
        //canvas.drawText(s, center.x - bounds.width() / 2, center.y + bounds.height() / 2, textPaint);
    }
